...
MIDDLEWARE = [
    ...
    #"django.middleware.csrf.CsrfViewMiddleware", # PODE TER PROBLEMAS COM A SEGURANCA _______________________________________________________________________________________
